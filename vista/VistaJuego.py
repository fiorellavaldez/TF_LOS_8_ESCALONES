...
#         #self.centralwidget = QtWidgets.QWidget(parent=MainWindow)
       ...
       ################################ 
        ...
        #self.ly_escalon1 = QtWidgets.QVBoxLayout()
     

        #self.wd_escalon1 = QtWidgets.QWidget()
        #self.wd_escalon1.setLayout(self.ly_escalon1)

        # Asegúrate de añadirlo correctamente al layout principal
        ...
        self.wd_escalon1.setMinimumSize(QtCore.QSize(920, 70))
        ...
        self.ly_escalon1.setContentsMargins(0, 0, 0, 0)  # Elimina márgenes para alineación
        self.ly_escalon1.setSpacing(10)  # Ajusta el espaciado según tus necesidades
        ...
        self.verticalLayout.addWidget(self.wd_escalon1, alignment=QtCore.Qt.AlignmentFlag.AlignCenter)
