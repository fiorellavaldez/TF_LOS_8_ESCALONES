...
#         self.__vista = Ui_MainWindow()
#         self.__vista.setupUi(self.MainWindow)
#         self.MainWindow.show()        # Configuración del botón "Atrás"
#         self.__vista.get_button_atras().clicked.connect(self.__volver_configuracion)        # Inicialización de la tabla
