...
class Sonido:
    def __init__(self, archivo=None):
        ...
        self.file_path = archivo if archivo else r"musica\\menu_2.mp3"  # Ruta de archivo por defecto

        # Si se ha proporcionado una ruta de archivo, lo configuramos
        if self.file_path:
            self.cambiar_musica(self.file_path)  # Establecer música si se proporciona un archivo
